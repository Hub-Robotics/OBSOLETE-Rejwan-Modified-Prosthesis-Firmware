...
#ifndef INCLUDESSRC_OV5640_REG_H_
#define INCLUDESSRC_OV5640_REG_H_



// OV5640 registered copied from ArduCAM
...
const struct OV5640_reg OV5640YUV_Sensor_Dvp_Init[] =
{
		{ 0x4740, 0x20 },
...
const struct OV5640_reg ov5640_vga_preview[] =
{
...
const struct OV5640_reg OV5640_RGB_QVGA_2[]  =
{		{ 0x3103, 0x11 },
		{0x3008, 0x02},
		{ 0x3820, 0x41 }, // Sensor flip off, ISP flip on
		{ 0x3821, 0x01 }, // Sensor mirror on, ISP mirror on, H binning on
		...
		{ 0x3709, 0x52 },
		{ 0x370c, 0x03 },
		{ 0x3a02, 0x05 }, // 60Hz max exposure, night mode 5fps
...
const struct OV5640_reg OV5640_RGB_QVGA[]  =
{
		...
		{ 0x3a03, 0xc4 }, // 60Hz max exposure
		{ 0x3a14, 0x05 }, // 50Hz max exposure, night mode 5fps
...
//2592x1944 QSXGA
const struct OV5640_reg OV5640_JPEG_QSXGA[]  =
{
...
//5MP
const struct OV5640_reg OV5640_5MP_JPEG[]  =
{
		{0x3800 ,0x00},
		{0x3801 ,0x00},
		{0x3802 ,0x00},
...
int Ov5640_Register_Conf(const struct OV5640_reg reglist[]);  // Function to configure Bunch of registers in struct format

void OV5640_set_JPEG_size(uint8_t size);             // All resoul
void OV5640_set_Light_Mode(uint8_t Light_Mode);      // Option: Auto, Sunny, Office, Cloudy, Home
void OV5640_set_Color_Saturation(uint8_t Color_Saturation); // Option: Saturation3, Saturation2, Saturation1, Saturation0
void OV5640_set_Brightness(uint8_t Brightness);  // Option: Level +4 to -4
void OV5640_set_Contrast(uint8_t Contrast);    // Option: Level +3 to -3
void OV5640_set_Special_effects(uint8_t Special_effect);  // Option: Normal, Blueish, Reddish, BW, Sepia, Negative, Greenish, Overexposure, Solarize,
void OV5640_set_Banding_Filter(uint8_t Banding_Filter);  // Off, +50 Hz, +60 Hz, Auto
void OV5640_set_EV(uint8_t EV); // Option: Level +3 to -3


#endif /* INCLUDESSRC_OV5640_REG_H_ */
